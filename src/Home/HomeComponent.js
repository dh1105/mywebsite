                        ...
                        <Card style={{ width: '100%', marginTop: '100px', marginBottom: '30px' }}>
                            <CardBody className="App">
                                ...
                                <Row style={{ justifyContent: 'center' }}>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<FaHiking size={50} style={{ color: '#fff' }} />} text="Hiking" backText="In the Himalayas" />
                                    </Col>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<FaMusic size={50} style={{ color: '#fff' }} />} text="Playing music" backText="On the guitar" />
                                    </Col>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<FaCamera size={50} style={{ color: '#fff' }} />} text="Photography" backText="Of landscapes and the night sky" />
                                    </Col>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<GiTennisRacket size={50} style={{ color: '#fff' }} />} text="Squash" backText="Alone or with a partner" />
                                    </Col>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<FaUtensils size={50} style={{ color: '#fff' }} />} text="Cooking" backText="Indian and Italian food" />
                                    </Col>
                                    <Col xs="8" sm="6" md="3" lg="2" style={{ marginBottom: '15px' }}>
                                        <FlippyOnHover flipDirection="horizontal" icon={<FaRunning size={50} style={{ color: '#fff' }} />} text="Running" backText="On a pleasant day" />
                                    </Col>
                                </Row>
